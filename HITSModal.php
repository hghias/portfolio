<!-- Michigan Medicine HITS Service Catalog Improvement !-->
<div class="modal p-3 p-lg-5" id="HITSModal"> 
   <!--  <img src="" alt="" style="width:100%;"> !-->
    <h3 class="text-center"> <b> Michigan Medicine HITS Service Catalog Improvement</b> </h3>
    <div class="p-lg-5">
     </br>
    <div class="row"> 
		<div class="col-lg-3">
		...
		<div class="col-lg-3">
			<h5><b>Team</b></h5>
			<p>Worked with the Project Lead, Marketing & Engagement Lead, Project Sponsor, Service Catalog Product Manager and Project Manager</p>
		</div>
		<div class="col-lg-3">
			<h5><b>Timeline</b></h5>
    ...
    <p>The assumption, based on limited data and customer input, is that a significant proportion of the customers are trying to reach these “right places” and failing.  A prime example includes using “Report a Problem” for something covered by a Service Catalog item.  The result for the customer is often frustration and time wasted in being redirected to the “right place”.  From an internal perspective, the “right places” also align with the most resource efficient methods as well.  Time taken to recover from misrouted work is inefficient and burdensome to a Service Desk that is already stretched thin. </br>
    Phase II aims to understand how the customer uses the Service Portal to find the “right place” for their issues, how successful they are being, and what we can do to make that effort as simple, correct, direct, and efficient as possible. I joined the team as the UX expert. I will construct and conduct user interviews, develop suggestions based on user feedback, and iterate across interview cohorts.</p>
    </br>
