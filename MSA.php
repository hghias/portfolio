...
<div class="mt-5 mb-5"> 
    ...
    <div class="row"> 
		...
		<div class="col-lg-2" >
			...
			<p>Redesigned <a href="http://www.muslims.studentorgs.umich.edu/" target="blank" style="color:#48A2B5;">website</a></p>
		</div>
		<div class="col-lg-2">
			<h5><b>Team</b></h5>
			<p>Worked closely with the MSA operations chair </p>
		</div>
		<div class="col-lg-2">
			<h5><b>Timeline</b></h5>
			<p>Oct 2018 - April 2019 </p>
		</div>
	</div>
    ...
    <h4> <b> Stakeholder Interviews </b></h4>
    ...
    <h4> <b>User Interviews & Surveys</b></h4>
    ...
    <div class="row"> 
    	<div id="carousel2" class="carousel slide col-lg-6 pt-2" data-ride="carousel">
		<ol class="carousel-indicators">
		...
		<div id="carousel3" class="carousel slide col-lg-6 pt-2" data-ride="carousel">
		<ol class="carousel-indicators">
...
<ul>
 ...
 <h5 style="color: #777777"> <b>Ideate</b> </h5>
    ...
    <h4> <b>Build</b> </h4>
    <p>I implemented the website using Wix, so board members can easily keep the website updated. View the website <a href="http://www.muslims.studentorgs.umich.edu/" target="blank" style="color:#48A2B5;">here</a>.</p>
     <!-- <div class="row">
		<div class="col text-center">
