...
<div class="mt-5"> 
    <img class="pt-lg-3 pl-lg-5 pr-lg-5 p-3" src="SCD-hero.png" alt="" style="width:100%;">
	</br>
	</br>
	<div class="padding-left padding-right">
		...
		<div class="col-lg-2">
			<h5><b>Role</b></h5>
			<p>Branding designer, UI/UX designer & developer</p>
		</div>
		...
		<div class="col-lg-2">
			<h5><b>Team</b></h5>
			<p>Worked closely with the owners of the company</p>
		</div>
		<div class="col-lg-2">
			<h5><b>Timeline</b></h5>
    ...
    <div class="row d-flex justify-content-center">
    	...
    	<div class="col-lg-4 pt-2">
    		<img class="w-100" src="SCD2.PNG" style="border: 1px solid #DEDDDD;">
    	</div>
    	<div class="col-lg-4 pt-2">
