...
<div class="container" data-aos="fade-up">
	...
	<ul>
		<li>Led and designed user research studies exploring customer behaviors with HITS Service Portal. Conducted user interviews and usability testing with 12 Michigan Medicine faculty and staff.</li>
	...
	<ul>
		<li>Redesigned workflow for purchasing a vehicle in SmartAuction, a wholesale vehicle auction marketplace, in a 100+ person team doing greenfield agile development.</li>
		<li>Conducted gap analysis of 50 vehicle purchase scenarios and created development reference workbook and hi-fidelity template used by 10+ developers and testers.</li>
	...
	<ul>  
		<li> B.A of Art & Design with concentration in user experience design 
		</li><li>Completed 20 credits in computer science including Data Structures & Algorithms.</li>
