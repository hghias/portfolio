...
<div style="display:none; max-width:1000px;" id="RedefineModal"> 
    ...
    <ul>
		...
		<li>Social Justice Organization</li>
	</ul>
	<p> Client Ideas: ​</p>
    <ul>
		<li>Paintbrush</li>
...
<script>
	...
	function hide(id) { 
		...
		if (id === 'ux') { 
			document.getElementById('branding').style.display = 'none'; //Will show
			document.getElementById('product').style.display = 'none'; //Will show
			document.getElementById('ux').style.display = 'block'; //Will hide		
		}
		
		else if (id === 'branding') { 
			document.getElementById('ux').style.display = 'none'; 
			document.getElementById('product').style.display = 'none'; 
			document.getElementById('branding').style.display = 'block'; //Will show		
		}
		
		else if (id === 'product') { 
			document.getElementById('branding').style.display = 'none'; //Will show
			document.getElementById('ux').style.display = 'none'; //Will show
			document.getElementById('product').style.display = 'block'; //Will hide		
		}
		
		else {
			document.getElementById('branding').style.display = 'block'; //Will show
			document.getElementById('ux').style.display = 'block'; //Will show
			document.getElementById('product').style.display = 'block'; //Will show
	
		}
	}
	*/

	/* document.getElementById("designbutton").onclick = function hide() { }; */

</script>
 
 <script>
 	//hover method from https://codepen.io/appai/pen/YPQmXZ 
